...
- Build adapter for the weather provider:
  - **Tomorrow.io** — realtime + forecast API with caching
...
- Keep provider interface focused on a single data source

**Deliverable:** Provider abstraction + working Tomorrow.io adapter + test report.
