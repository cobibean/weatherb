...
function AccountHeader({ afterglow }: { afterglow: boolean }): React.ReactElement {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="md:hidden mx-auto max-w-6xl mt-2 origin-top"
        initial={false}
        ...
        >
          {navLinks.map((link) => (
            <Link
              ...
              className="relative flex items-center justify-between px-4 py-3 text-base font-semibold text-neutral-700 hover:text-neutral-900 hover:bg-white/60 rounded-2xl transition-colors focus-ring"
            >
