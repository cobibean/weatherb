...
const ERROR_SELECTORS: Record<string, { name: string; message: string }> = {
  '0xa820742e': {
    name: 'AlreadyBet',
    message:
      'You have already placed a bet on this market. Each wallet can only bet once per market.',
  },
  ...
  '0x3a81d6fc': {
    name: 'InvalidStatus',
    message: 'This market is not in the correct status for this action.',
  },
  '0x2ef5f21e': {
    name: 'BettingClosed',
    message:
      'Betting is closed for this market. Betting closes 10 minutes before the resolve time.',
  },
  '0x6d8e7e4d': {
    name: 'BetTooSmall',
    message: 'Your bet amount is too small. Minimum bet is 0.01 USDC.',
  },
  '0xb5cf5b8f': { name: 'TooEarly', message: 'It is too early to perform this action.' },
  '0x63e5d7cb': { name: 'OnlyNativeCurrency', message: 'Only native currency (USDC) is supported.' },
